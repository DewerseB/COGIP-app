...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 13 sep. 2020 à 20:29
...
INSERT INTO `companies` (`company_id`, `name`, `VAT`, `country`, `company_type_id`) VALUES
...
(6, 'Einstein', 'Albert', 'Einstein@hotmail.com', '555-6489', 5);
...
(9, 'RF15-10-09-2020', '2020-09-10', 5, 5);
...
ALTER TABLE `companies`
  ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`company_type_id`) REFERENCES `company_type` (`company_type_id`) ON UPDATE CASCADE;

--
-- Contraintes pour la table `contacts`
--
ALTER TABLE `contacts`
  ADD CONSTRAINT `contacts_ibfk_3` FOREIGN KEY (`company_id`) REFERENCES `companies` (`company_id`) ON UPDATE CASCADE;
...
ALTER TABLE `invoices`
  ...
  ADD CONSTRAINT `invoices_ibfk_2` FOREIGN KEY (`company_id`) REFERENCES `companies` (`company_id`) ON UPDATE CASCADE;
COMMIT;
